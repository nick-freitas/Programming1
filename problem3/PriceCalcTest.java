...
public class PriceCalcTest
{
    ...
    public static void main( String[] args )
    {
        ...
        PriceCalc PC = new PriceCalc(gadgetNumber, gadgetWeight, pricePerPound, taxRate);
        ...
        //Prints a discount message if the user has qualified for a discount
        if ( PC.applyDiscount() )
        {
            System.out.printf(
              "\nYou purchased more %.2f pounds of gadgets, so you will receive a %.2f%% discount!\n",
              PC.getDiscountWeight(), PC.getDiscountPercentage() * 100);
        }
