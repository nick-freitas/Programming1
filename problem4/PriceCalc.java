 ...
 * methods; getSubtotal(), getValueDiscount(), getTax(), and getTotal(). The
 * greatest values can be for any of these is 1.7976931348623157e(308).
 *
 * <br/><br/>
 *
...
public class PriceCalc
{
    ...
    // Constants
    private final double MINIMUM_PPP = 0.49; // the minimum price per pound that the user can set
     ...
     * @return
     */
    public double getTotalGadgetWeight()
    {
        return getGadgetNumber() * getGadgetWeight();
    }

    /**
     * Calculates and return the subtotal, as the product of the number of
     * gadgets, the weight of the gadget, and the price per pound.
     *
     * @return Returns the subtotal as a double.
     */
    public double getSubtotal()
    {
        return ( getTotalGadgetWeight() * getPricePerPound() );
    }

    /**
     * Calculates and returns the value discount.
     * <br/><br/>
     * Calculates and return the value discount, as the subtotal, and the
     * discount percentage.
     *
    ...
    {
        if ( getTotalGadgetWeight() > DISCOUNT_WEIGHT )
        {
            return getSubtotal() * DISCOUNT_PERCENTAGE;
        }
        return 0;
    }
     ...
     * <br/><br/>
     * Calculates and returns the tax, as a product of the subtotal and the tax
     * rate, applying a discount if applicable to the price before tax before
    ...
    {
        return getPretax() * taxRate;
    }

    /**
     * Calculates and returns the total.
     * <br/><br/>
     * Calculates and return the total, as the subtotal, minus the value
     * discount if applicable, plus the tax
     *
     * @return Returns the total as a double.
     */
    public double getTotal()
    {
        return getPretax() + ( 1 + taxRate );
    }
    ...
    {
        return ( pricePerPound >= MINIMUM_PPP );
    }
